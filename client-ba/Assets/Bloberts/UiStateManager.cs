...
public class UiStateManager : MonoBehaviour
{
    ...
    private async void Update()
    {
        ...
        {
            KeyStorageManager.SaveKeyPair(BlobertUitls.Address0sFix(DojoEntitiesStatic.currentAccount.Address.Hex()), DojoEntitiesStatic.currentAccount.Signer.Inner.Hex());
        }
