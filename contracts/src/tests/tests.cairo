...
mod test {
    ...
    fn test_combat() {
        ...
        let traits_ben = Traits {
            armour: Armour::DivineRobe,
            background: Background::Terraforms,
            jewelry: Jewelry::Amulet,
            mask: Mask::Bane,
            weapon: Weapon::Katana,
        };
        ...
        let stats_ben = calculate_stats(traits_ben);
        println!(
        ...
        println!(
            "ben Stats: attack: {} defense: {} speed: {} strength: {}",
            stats_ben.attack,
            stats_ben.defense,
            stats_ben.speed,
            stats_ben.strength
        ...
        loop {
            ...
            loop {
                ...
                let (damage_a, damage_b) = calculate_damage(stats_a, stats_ben, outcome);
